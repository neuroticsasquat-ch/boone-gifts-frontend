...
export const routes: RouteObject[] = [
  // The depth counter every back control reads has to live inside the router,
  // because it watches navigations, and `App.tsx` puts `AuthProvider` above
  // `RouterProvider` — so one pathless root route is where it goes. At the root
  // rather than inside `<Layout>`, because `family-invites/:token` sits outside
  // the shell and arriving at a family from an invite is an in-app push that has
  // to count.
  {
    element: (
