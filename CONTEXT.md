...
| **Occasion** | A family's shared gifting occasion — "Christmas 2026". The unit a list is shared *to*, and the only thing that makes a family shareable | `pages/family-detail/OccasionsSection.tsx`, `lib/occasion-choice.ts` |
