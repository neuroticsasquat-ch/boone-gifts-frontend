...
src/
  ...
  components/
    ...
    SharingModal.tsx      # "Who can see this list" — the owner's one sharing
                          # surface, in components/ because New List mounts it
                          # too (NEU-1307). Held open at `?share=open`
...
## Testing
- 670 test cases across 51 files, run inside the container via `task test`
